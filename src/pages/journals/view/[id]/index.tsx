            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('journal', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/journals/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem
                  label="Entry Date"
                  text={data?.entry_date ? format(parseISO(data?.entry_date as unknown as string), 'dd-MM-yyyy') : ''}
                />

                <FormListItem label="Description" text={data?.description} />

                <FormListItem label="Debit" text={data?.debit} />

                <FormListItem label="Credit" text={data?.credit} />
