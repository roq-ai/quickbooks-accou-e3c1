...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`quickbooks accounting software alike`}</title>

        <meta
          name="description"
          content="Experience the power of QuickBooks Accounting Software Alike - your reliable partner for seamless cloud accounting just like QuickBooks online."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1554224154-26032ffc0d07?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhY2NvdW50aW5nfGVufDB8fHx8MTY5NjEyMjYwN3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`quickbooks accounting software alike`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the power of QuickBooks Accounting Software Alike - your reliable partner for seamless cloud accounting just like QuickBooks online.`}
            </Text>
            <Box
