...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Product Addition.create': {
    roles: ['business-owner', 'accountant', 'financial-manager', 'customer-service'],
    key: 'product_addition',
    tenantPath: [],
    userPath: [],
  },
  'Financial Report Generation.create': {
    roles: ['business-owner', 'accountant'],
    key: 'financial_report_generation',
    tenantPath: [],
    userPath: [],
  },
  'Customer Complaint Registration.create': {
    roles: ['business-owner', 'accountant', 'financial-manager', 'employee'],
    key: 'customer_complaint_registration',
    tenantPath: [],
    userPath: [],
  },
};
